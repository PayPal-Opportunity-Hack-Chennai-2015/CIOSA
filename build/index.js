...
(function() {
	...
	function sendRequest(url, callback, postData){
		...
		if (postData) {
			req.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
						req.setRequestHeader('Access-Control-Allow-Origin', 'http://lm-maa-26500421.paypalcorp.com/');
		}
    ...
    {
    	var uri = "http://lm-maa-26500421.paypalcorp.com:9200/sahayak/ngodetails/"+id;
    	sendRequest(uri,function(resp){
    		...
    		for(var o in s)
    		{
				if(o=='logo'||o=='desc'||o=='categories'||o=='location')
				{
					//alert("MAni");
					//do nothing
				}
    ...
    var getDistinctPlaces =function(callback){
    	var uri = "http://lm-maa-26500421.paypalcorp.com:9200/sahayak/ngodetails/_search";
...
(function() {
	...
	var paginator = {
		...
		pagesize: 100,
		totalResults: 0,
		uri:'http://lm-maa-26500421.paypalcorp.com:9200/sahayak/ngodetails/_search?size={0}&from={1}',
		init: function(){
